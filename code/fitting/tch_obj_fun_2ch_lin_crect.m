function obj_fun = tch_obj_fun_2ch_lin_crect(roi, model)
% Generates anonymous objective function that can be passed to fmincon for
% 2-channel model with optimized linear sustained and rectified + 
...
if ~strcmp(model.type, '2ch-lin-crect'); error('Incompatible model type'); end
