...
% the 2ch-exp-quad model (optimized 2-channel model with adapted sustained
...
conv_nb = @(s, tau_s, tau_ae) cellfun(@(S, T) [S T], ...
    conv_nbS(s, tau_s, tau_ae), conv_nbT(s, tau_s), 'uni', false);
