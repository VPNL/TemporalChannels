...
f1 = zeros(size(x1));
Q1  = find(x1 > 0);   
f1(Q1) = exp((h1(1)-1) .* log(x1(Q1)) + h1(1) .* log(l1(1)) - l1(1) .* x1(Q1) - gammaln(h1(1)));
...
f2 = zeros(size(x2));
Q2 = find(x2 > 0);
f2(Q2) = exp((h2(1) - 1) .* log(x2(Q2)) + h2(1) .* log(l2(1)) - l2(1) .* x2(Q2) - gammaln(h2(1)));
