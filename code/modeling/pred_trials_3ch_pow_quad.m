function model = pred_trials_3ch_pow_quad(model)
% Generates trial predictors using a 3 temporal-channel model with CTS-pow
% on sustained, quadratic transient, and optimized delay channel. 
