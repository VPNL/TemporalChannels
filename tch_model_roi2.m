function [roi, model] = tch_model_roi2(name, type, fit_exps, val_exps, opt_proc, sessions)
...
roi(1).tr = 2; roi(1) = tch_runs(roi(1));

% setup tchModel object to apply to tchROI
model(1) = tchModel(type, fit_exps, roi(1).sessions); model(1).tr = 2;
